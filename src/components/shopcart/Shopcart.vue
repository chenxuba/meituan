      ...
      <div class="shopcart-wrapper">
        ...
        <div class="content-left">
            ...
            <div class="desc-wrapper">
                ...
                <p class="tip" :class="{'highligh':totalCount>0}">另需{{poilist.shipping_fee_tip}}</p>
            </div>
        </div>
        <!-- 底部右侧 -->
        ...
        <div class="shopcart-list" v-show="listShow" :class="{'show':listShow}">
          <div class="list-top" v-if="poilist.discounts2" >
            {{poilist.discounts2[0].info}}
          </div>
...
export default {
  ...
  props:{
    ...
    selectFoods:{  //用来接收父组件传递过来的selectFoods
      type:Array,
      default(){
        return[
  ...
  computed:{
    ...
    payStr() {  //右侧去结算显示
      if (this.totalCount > 0) {
        ...
        return this.poilist.min_price_tip;
      }
    },
    listShow(){
      if(!this.totalCount){
